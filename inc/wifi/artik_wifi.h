 ...
 *  \example wifi_test/artik_wifi_ap_test.c
 */
...
/*!
 *  \brief Maximum length for Access Points wpa2 password
 *
 *  Maximum length allowed for Access Points
 *  wpa2 password
 */
#define MAX_AP_WPA2PASS_LEN 64

/*!
 *  \brief Minimum length for Access Points wpa2 password
 *
 *  Minimum length allowed for Access Points
 *  wpa2 password
 */
#define MIN_AP_WPA2PASS_LEN 8

/*!
 *  \brief Higher channel for Access Points
 *
 *  Higher channel allowed for Access Points
 *
 */
#define MAX_AP_CHANNEL 52
 ...
 *
 *  Callback prototype for Wi-Fi callback functions. When
 *  passed to \ref set_connect_callback, \ref result is
 *  mapped to a pointer to \ref artik_wifi_connection_info. If passed
 *  to
...
typedef struct {
	 ...
	 *             function. It is up to the caller to free it after
	 *             use.
	 ...
	 * \param[in] password Password of the access point. NULL for Open
	 *            authentication.
	 * \param[in] persistent If true, the profile is saved for auto
	 *            connection upon reboot.
	 *
	 * \return S_OK on success, otherwise a negative error value.
	 */
	 ...
	 * \param[in] user_data Pointer to the client data that will be passed
	 *            to the callback. This parameter can be set to NULL.
	 * \return S_OK on success, otherwise a negative error value.
	 */
	 ...
	 *
	 * \param[in] user_callback Callback function to register for receiving
	 *            connection result.
	 * \param[in] user_data A pointer to the client data that will be passed
	 *            to the callback. This parameter can be set to NULL.
	 *
	 * \return S_OK on success, otherwise a negative error value.
	 */
