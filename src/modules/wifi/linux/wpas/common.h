...
#ifdef __GNUC__
#define PRINTF_FORMAT(a, b)	__attribute__((__format__(printf, (a), (b))))
...
#ifndef bswap_16
#define bswap_16(a)	((((u16) (a) << 8) & 0xff00) | (((u16) (a) >> 8) \
			& 0xff))
#endif
...
static inline char *MAC2STR_BY_FORMAT(char *format, const u8 *addr)
{
	char str[128] = "";
...
#define MAC2STR(addr) MAC2STR_BY_FORMAT("%02x:%02x:%02x:%02x:%02x:%02x", addr)

/*
 * Compact form for string representation of MAC address
 * To be used, e.g., for constructing dbus paths for P2P Devices
 */
#define COMPACT_MAC2STR(addr) MAC2STR_BY_FORMAT("%02x%02x%02x%02x%02x%02x", \
				addr)
